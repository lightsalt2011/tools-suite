android=/home/lvfeng/disk_ext/trunk/8992/android_rom
#binutil=/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9
parsetools=~/disk_ext/trunk/8992/android_rom/vendor/qcom/opensource/tools/linux-ramdump-parser-v2/
...
--ram-file ./DDRCS0_0.BIN 0x00000000 0x2FFFFFFF --ram-file ./DDRCS0_1.BIN 0x80000000 0xAFFFFFFF --ram-file ./DDRCS1_0.BIN 0x30000000 0x5FFFFFFF --ram-file ./DDRCS1_1.BIN 0xB0000000 0xDFFFFFFF \
