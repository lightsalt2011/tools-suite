...
--gdb-path "$android"/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-gdb \
 --ram-file ./DDRCS0_0.BIN 0x00000000 0x3FFFFFFF --ram-file ./DDRCS0_1.BIN 0x40000000 0x7FFFFFFF --ram-file ./OCIMEM.BIN 0xFE800000 0xFE80FFFF --phys-offset 0x00000000 --64-bit --force-hardware 8992 --dmesg --check-for-watchdog --cpu-state --dump-page-tables  --print-pagetracking --print-pagetypeinfo  --check-rodata  --print-runqueues  --print-vmalloc  --print-vmstats --print-irqs --print-workqueues --print-kconfig --print-tasks --t32launcher --parse-debug-image --qtf --print-rtb --ddr-compare --clock-dump --cpr-info --thermal-info --timer-list --outdir ./AP_logs
